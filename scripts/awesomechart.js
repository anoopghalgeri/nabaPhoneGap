...
function AwesomeChart(canvasElementId){
    ...
    this.titleFillStyle = '#FFF';
    this.titleFont = 'sans-serif';
    this.titleFontHeight = 11;
    ...
    this.pieBorderWidth = 0;
    this.pieShadowColor = 'rgba(0, 0, 0, 0.7)';
    this.pieShadowBlur = 5;
    this.pieShadowOffsetX = 0.0;
    this.pieShadowOffsetY = 3.0;
    ...
    */
    ...
    this.drawPieChart = function (ring) {
        ...
        var pieAreaWidth = this.width;
        var pieAreaHeight = this.height;
...
//            alert('Drawring 2: centerX=' + centerX + '; centerY=' + centerY +
//                  '; radius=' + radius + '; currentAngle=' + currentAngle + '; incAngleBy=' + incAngleBy);

            if (incAngleBy > 6.28) {
                //360 degrees arc - split into two parts
                endAngle = currentAngle + incAngleBy / 2.0;
