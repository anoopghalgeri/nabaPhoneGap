    ...
    function propExists(prop) {
        ...
        for (var v in props) {
            if (fbCSS[props[v]] !== undefined) {
                //if (prop.toLowerCase() == "boxshadow") alert('boxshadow supported!!');
                return true;
            }
        }
    }
...
$.widget( "mobile.page", $.mobile.widget, {
	...
	_create: function() {
		...
		this.element
		    ...
		    .append('<div class="dv-bg-shadow"></div>');
	    while (this.element[0].childNodes.length > 1) {
	        this.element[0].lastChild.appendChild(this.element[0].firstChild);
	    }
	},
...
--------------------------------------*/
	...
	*/
	...
	function resetActivePageHeight(){
		...
		//$( "." + $.mobile.activePageClass ).css( "min-height", window.screen.height );
	    //$("." + $.mobile.activePageClass).css("min-height", getScreenHeight());
	    $("." + $.mobile.activePageClass).css("min-height", window.innerHeight);
	}
...
$.widget( "mobile.collapsible", $.mobile.widget, {
	...
	_create: function() {
        ...
        var colSch = collapsibleHeading.attr("data-colorScheme");
        collapsibleContent.addClass("ui-collapsible-" + colSch);
//	    switch (collapsibleHeading.attr("data-colorScheme")) {
//	        case "name-g":
//	            collapsibleContent.addClass("ui-collapsible-color1");
//	            break;
//	        case "name-p":
//	            collapsibleContent.addClass("ui-collapsible-color2");
//	            break;
//	        case "name-b":
//	            collapsibleContent.addClass("ui-collapsible-color3");
//	            break;
//	        case "name-gr":
//	            collapsibleContent.addClass("ui-collapsible-color4");
//	            break;	            
//	        default:
//	    }
	    ...
	    collapsibleContent.wrapInner("<div class='menu-inner-container'></div>");
	    ...
	    var bTopicTest = collapsibleHeading.find(".topic-btns")[0];
	    var bTopicTestTo = collapsibleHeading.find("a")[0];
	    if (bTopicTest)
	        bTopicTestTo.appendChild(bTopicTest);
		...
		collapsible
			.bind( "expand collapse", function( event ) {
				if ( !event.isDefaultPrevented() ) {
				    ...
				    /*switch (collapsibleHeading.attr("id")) {
				        case "name-g":
				            collapsibleHeading.find(".menu-right-btn1")
    				            .toggleClass("menu-right-btn1-g-collapsed", !isCollapse)
    				            .toggleClass("menu-right-btn-color1", isCollapse);
				            break;
				        case "name-p":
				            collapsibleHeading.find(".menu-right-btn1")
    				            .toggleClass("menu-right-btn1-p-collapsed", !isCollapse)
    				            .toggleClass("menu-right-btn-color2", isCollapse);
				            break;
				        case "name-b":
				            collapsibleHeading.find(".menu-right-btn1")
    				            .toggleClass("menu-right-btn1-b-collapsed", !isCollapse)
    				            .toggleClass("menu-right-btn-color3", isCollapse);
				            break;
				        case "name-gr":
				            collapsibleHeading.find(".menu-right-btn1")
    				            .toggleClass("menu-right-btn1-gr-collapsed", !isCollapse)
    				            .toggleClass("menu-right-btn-color4", isCollapse);
				            break;
				        default:
				    }*/
	    ...
	    collapsibleHeading
    	    .bind("click", function(event) {
				...
				if (event.target.innerHTML.trim() == "Take<br>Quiz")
					return;
...
$( document ).delegate( ":jqmData(role='listview')", "listviewcreate", function() {
    ...
    $(".ui-input-search").children().wrapAll("<div class='input-wrap'></div>");
    $('<h3>Results:</h3>').insertAfter('.ui-listview-filter');
});
...
(function ($, undefined) {
    ...
    $.fn.buttonMarkup = function(options) {
        ...
        for (var i = 0; i < this.length; i++) {
            ...
            var swirlyIcon = null;
            if (o.icon == 'plus-swirlyq') {
                swirlyIcon = document.createElement("span");
                o.icon = 'plus';
            }
            ...
            if (e.firstChild) {
                var attr = e.parentNode.attributes["data-colorscheme"];
                if (attr != undefined) {
                    buttonClass = "ui-btn color-button-norm ui-shadow button-norm-" + attr.value;
                    e.setAttribute("data-buttonColor", attr.value);
                }
                else {
            ...
            if (swirlyIcon) {
                swirlyIcon.className = "swirlyq-icon";
                buttonInner.appendChild(swirlyIcon);
            }
            
            var buf = document.createElement(o.wrapperEls);

            while (e.firstChild) {
                if (e.firstChild.className == "menu-tabs") {
                    buf.appendChild(e.firstChild);
                }
                else {
        ...
        $(document).bind({
            "vmousedown": function (event) {
                ...
                if (btn) {
                    ...
                    sstheme = $btn.attr("data-buttonColor");
                    if ($btn.hasClass("button-norm-" + sstheme) || $btn.hasClass("button-hover-" + sstheme)) {
                        $btn
                        .removeClass("button-norm-" + sstheme)
    			        .removeClass("button-hover-" + sstheme)
                        .removeClass("color-button-norm")
    			        .removeClass("color-button-hover")
    			        .removeClass("ui-btn-up-" + theme)
    			        .removeClass("ui-btn-hover-" + theme)
    			        .addClass("button-down-" + sstheme)
                        .addClass("color-button-down");
                    } 
                    else {
                        $btn.removeClass("ui-btn-up-" + theme)
    			        .removeClass("ui-btn-hover-" + theme)
            ...
            "vmousecancel vmouseup": function (event) {
                ...
                if (btn) {
                    ...
                    theme = $btn.attr("data-" + $.mobile.ns + "theme");
                    sstheme = $btn.attr("data-buttonColor");
                    if ($btn.hasClass("button-down-" + sstheme) || $btn.hasClass("button-hover-" + sstheme) || $btn.hasClass("button-norm-" + sstheme)) {
                        $btn
                        .removeClass("button-down-" + sstheme)
                        .removeClass("color-button-down")
    			        .removeClass("ui-btn-down-" + theme)
    			        .addClass("button-norm-" + sstheme)
    			        .addClass("color-button-norm");
                    } 
                    else {
                        //alert("vmousecancel vmouseup " + $btn.attr("class"));
            ...
            "vmouseover focus": function (event) {
                ...
                if (btn) {
                    ...
                    sstheme = $btn.attr("data-buttonColor");
                    theme = $btn.attr("data-" + $.mobile.ns + "theme");
                    if ($btn.hasClass("button-down-" + sstheme) || $btn.hasClass("button-norm-" + sstheme)) {
                        $btn
                        .removeClass("button-norm-" + sstheme)
                        .removeClass("color-button-norm")
    			        .removeClass("ui-btn-up-" + theme)
    			        .addClass("button-hover-" + sstheme)
    			        .addClass("color-button-hover");
                    } 
                    else {
                        //alert("vmouseover focus " + $btn.attr("class"));
            ...
            "vmouseout blur": function (event) {
                ...
                if (btn) {
                    ...
                    sstheme = $btn.attr("data-buttonColor");
                    theme = $btn.attr("data-" + $.mobile.ns + "theme");
                    if ($btn.hasClass("button-hover-" + sstheme) || $btn.hasClass("button-norm-" + sstheme) || $btn.hasClass("button-down-" + sstheme)) {
                        $btn
                        .removeClass("button-hover-" + sstheme)
                        .removeClass("color-button-hover")
    			        .removeClass("ui-btn-hover-" + theme + " ui-btn-down-" + theme)
    			        .addClass("button-norm-" + sstheme)
    			        .addClass("color-button-norm");
                    } 
                    else {
                        //alert("vmouseout blur " + $btn.attr("class"));
    ...
    $.mobile.fixedToolbars = (function () {
        ...
        return {
            ...
            show: function (immediately, page) {
                $.mobile.fixedToolbars.clearShowTimer();
                if ($(window).scrollTop() == currentTop && $(this).is(".ui-header-fixed")) {
                    //alert('return from show');
                    return null;
                }
            ...
            hide: function (immediately) {
                if ($(window).scrollTop() == currentTop) return null;
                currentstate = "inline";
                //alert('inline');
...
(function( $, window, undefined ) {
	...
	$.extend($.mobile, {
		...
		showPageLoadingMsg: function() {
		    //alert($window.height() + ' ' + $loader.height() + ' ' + window.screen.height + ' ' + window.innerHeight);
			if ( $.mobile.loadingMessage ) {
			    ...
			    $loader.find("span").css({
			        'margin-top': $.support.scrollTop && $window.scrollTop() + screenHeight / 2 - 30 ||
			        activeBtn.length && activeBtn.offset().top || 100
			    });
			}
