...
//            }
            ...
            pickWinTop = ($(window).height() - (pickWinHeight + 2)) / 2;
...
//            }
            ...
            if (!o.disabled) {
                if (!o.useDialogForceTrue || o.useDialogForceFalse || o.fullScreen) {
                    o.useDialog = false;
                    ...
                    if (o.fullScreenAlways || o.fullScreen) {
                        self.pickerContent.css({ 'border': '0px !important', 'position': 'fixed', 'top': fullTop, 'left': fullLeft, 'height': docWinHeight, 'width': docWinWidth, 'maxWidth': docWinWidth }).addClass('ui-overlay-shadow in').removeClass('ui-simpledialog-hidden');
                    } else {
                        self.pickerContent.css({ 'position': 'fixed', 'top': pickWinTop, 'left': pickWinLeft }).addClass('ui-overlay-shadow in').removeClass('ui-simpledialog-hidden');
                    }
                } else {
            ...
            if (self.options.onOpened && typeof (self.options.onOpened) === "function") {
        ...
        _reposition: function () {
            ...
            self.pickerContent.css({ 'position': 'fixed', 'width': pickWinWidth, 'top': pickWinTop, 'left': pickWinLeft });
        },
        refresh: function () {
